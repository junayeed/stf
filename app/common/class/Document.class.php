    ...
    function uploadDocument($doc_id = null)
    {
  	...
  	$remote_filename                 = $returnValue['remote_filename'];
        ...
        if ($_FILES['document']['error']  == 0)
        {
            ...
            {    
                if(!file_exists($this->doc_dir . '/' . $uid))
                    mkdir($this->doc_dir . '/' . $uid);
            }
            ...
            {    
                //$save_as  =  $this->doc_dir . '/' . $uid . '/' . $remote_filename . '.' . $fileExt;
                $save_as  =  $this->doc_dir . '/' . $uid . '/' . $remote_filename ;
            }    
