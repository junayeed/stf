<?php
   ...
   *
   * Purpose: the functions found in the library are widely used througout.
   *
   *
   * History
   *
   ...
   */
   ...
   function getLatestCustomerList()
   {
       $info['table']  = CUSTOMERS_TBL;
       $info['debug']  = false;
       $info['fields'] = array('id', 'company_name');
       $info['where']  = '1 ORDER BY last_access DESC LIMIT 0, 5';
   ...
   */
   function createPage($template = null, $data = null)
   {
      ...
      $customer_list = getLatestCustomerList();
      ...
      $smarty->assign('USER_IMAGE', $_SESSION['user_image']);
