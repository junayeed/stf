 ...
 */
   ...
   * Template Constant
   */
   define('ARTWORK_REPORT_EDITOR_TEMPLATE',          TEMPLATE_DIR . '/artwork_report_manager.html');
   define('ARTWORK_REPORT_LIST_TEMPLATE',            TEMPLATE_DIR . '/artwork_report_list.html');
