...
/**
 * File: schedule_manager.conf.php
 * This is the configuration file for the schedule manager application
 *
 */
   ...
   * Template Constant
   */
   define('SCHEDULE_EDITOR_TEMPLATE',          TEMPLATE_DIR . '/schedule_manager.html');
   define('SCHEDULE_LIST_TEMPLATE',            TEMPLATE_DIR . '/schedule_list.html');
