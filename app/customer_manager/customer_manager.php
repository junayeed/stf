 ...
 * instantiate the customer manager application
 */
   ...
   require_once(EXT_DIR                   .'/capsule/Services/Capsule.php');
   //echo AJAX_DIR;

   // Instantiate the customer manager class
   $thisApp  = new customerManagerApp();
