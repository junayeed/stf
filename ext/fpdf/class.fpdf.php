...
function FPDF($orientation='P',$unit='mm',$format='A4')
{
	...
	//Page margins (1 cm)
        ...
        //$margin=28.35/$this->k;  // Comment out by Junayeed on 29/06/2013
        $margin = 5;
        
	// $this->SetMargins($margin,$margin); // Comment out by Junayeed on 29/06/2013
	$this->SetMargins($margin+5,$margin); // updated by Junayeed on 29/06/2013
