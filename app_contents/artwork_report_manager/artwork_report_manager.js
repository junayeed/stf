/*
 *   File: artwork_report_manager.js
 *
 */

var itemStatusArray  = new Array('With Designer', 'Proof on file', 'Awating Client', 'Approved', 'Filed', 'Archived');
...
function doClearForm()
{
    ...
    location.href = 'http://'+document.domain+'/app/artwork_report_manager/artwork_report_manager.php';
}
