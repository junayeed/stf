...
function CalendarPopup() {
	...
	c.yearSelectStartOffset = 50;  // Increased to 50. Previously it was 5. Changed by Junayeed on 12/3/2012 9:04PM 
	c.currentDate = null;
	c.todayText="Today";
	c.cssPrefix="";
...
function CP_getCalendar() {
	...
	if (this.displayType=="date" || this.displayType=="week-end") {
		...
		if (this.isShowNavigationDropdowns) {
			...
			// commented out on 12/3/2012 8:58PM by Junayeed
			// only want to show past years. 
