...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'E:/xampp/htdocs/stf/app_contents/user_manager/user_manager.html', 32, false),)), $this); ?>
                                                ...
                                                <div class="box-widget">
                                                    ...
                                                    <div class="widget-container">
                                                        <div class="widget-block">
                                                            <div class="widget-content box-padding">
                                                                <p class="muted">
                                                                    Current Session is :<b><?php echo $this->_tpl_vars['sessionInfo']->year; ?>
</b>
                                                                </p>
                                                                <br>
